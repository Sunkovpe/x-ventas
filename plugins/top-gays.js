let handler = async (m, { conn, args, participants, isAdmin, isBotAdmin, isOwner, isPrems, usedPrefix, command }) => {
  ...
  try {
    ...
    let txt = `╭─「 ✦ 𓆩🏳️‍🌈𓆪 ᴛᴏᴘ ɢᴀʏs ᴅᴇʟ ɢʀᴜᴘᴏ ✦ 」─╮\n`
    txt += `│\n`
    ...
    console.error('Error en top gays:', e)
    return conn.sendMessage(m.chat, {
      text: '《✧》Ocurrió un error al generar el top de gays del grupo.',
      contextInfo: {
        ...rcanal.contextInfo
      }
    }, { quoted: m })
...
handler.help = ['#topgays']
handler.tags = ['fun', 'grupos']
handler.command = ['topgays', 'topgay', 'gays', 'gaytop']
handler.group = true
